...
public class AdicionalesProvider {
    ...
    public void setAdicionales(ArrayList<String>dias_semana_,String h_Incial,String h_Final,String exp_CreditoGrupal,String camp,String est,boolean cons_BuroDeCredito){
        nuevosAdicionales(dias_semana_,h_Incial,h_Final,exp_CreditoGrupal,camp,est,cons_BuroDeCredito);
    }
    private void nuevosAdicionales(ArrayList<String>dias_semana_, String h_Incial_, String h_Final_, String exp_CreditoGrupal_, String camp_, String est, boolean cons_BuroDeCredito_){
